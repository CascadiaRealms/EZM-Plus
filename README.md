...
# Enhanced Zeus Modules Plus
**Enhanced Zeus Modules (EZM)** was originally created by [GamesByChris](https://github.com/Chrisdw1002) and [M9-SD](https://github.com/M9-SD) as a private script for Public Zeus. After scripted compositions were added Expung3d took the base functionality from EZM and made it into a public composition. Since the public release of EZM, the script has grown substantially and is now the go-to solution for vanilla Zeus improvements. Later, modifications made by Expung3d were found to violate BIS terms of service. It was then modified and refactored by LindorffS to a) comply with BIS terms of service, and b) be easier to modify and extend.
